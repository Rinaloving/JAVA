...
<body style="background-color:#D1EEEE;">
	...
	<!-- <div style="width:1600px;height:440px;">
	 ...
	 <div style="width:500px;height:388px;margin-left:-500px;margin-top:52px;background-color:#EED2EE;float:left;">
	 	
	 </div>
	 <div style="width:600px;height:440px;border:2px solid;background:black;float:left;margin-left:0px;">
		
	</div> 
	<div style="width:490px;height:52px;margin-right:6px;margin-top:0px;background-color:#CD8C95;float:right;" ><span style=" font-size: 20px;text-align:center;display:block;line-height:50px;color:snow;">特 别 鸣 谢</span></div>
	 <div style="width:490px;height:388px;margin-right:6px;margin-top:0px;background-color:#EED2EE;float:right;"></div>
	</div> -->
